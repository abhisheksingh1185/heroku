...
public interface QBWebConnectorSvcSoap {
     ...
     * @param strUserName
     * @return
     *     returns com.ct.quickbooks.ws.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "authenticate", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.Authenticate")
    @ResponseWrapper(localName = "authenticateResponse", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.AuthenticateResponse")
    ...
    @RequestWrapper(localName = "sendRequestXML", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.SendRequestXML")
    @ResponseWrapper(localName = "sendRequestXMLResponse", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.SendRequestXMLResponse")
    ...
    @RequestWrapper(localName = "receiveResponseXML", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.ReceiveResponseXML")
    @ResponseWrapper(localName = "receiveResponseXMLResponse", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.ReceiveResponseXMLResponse")
    ...
    @RequestWrapper(localName = "connectionError", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.ConnectionError")
    @ResponseWrapper(localName = "connectionErrorResponse", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.ConnectionErrorResponse")
    ...
    @RequestWrapper(localName = "getLastError", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.GetLastError")
    @ResponseWrapper(localName = "getLastErrorResponse", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.GetLastErrorResponse")
    ...
    @RequestWrapper(localName = "closeConnection", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.CloseConnection")
    @ResponseWrapper(localName = "closeConnectionResponse", targetNamespace = "http://developer.intuit.com/", className = "com.ct.quickbooks.ws.CloseConnectionResponse")
